...
class LinkInterface():
    ...
    def __init__(self, path_to_carabiner, tcp_ip='host.docker.internal', tcp_port=17000, buffer_size=1024, callbacks=None):
        self._tcp_ip = tcp_ip
    ...
    def now(self):
        ...
        return int(monotonic.monotonic() * 1000 * 1000)
